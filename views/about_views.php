<body>
    ...
    <header>
        ...
        <div class="nav-container">
            ...
            <nav class="site-nav bg-white mt-2">
                <ul class="pl-3">
                    <li><a class="text-hover-purple" href="index.php"><i class=" site-nav--icon"></i>HOME</a></li>
                    <li><a class="text-hover-purple" href="about_us.php"><i class=" site-nav--icon"></i>ABOUT</a></li>
                    <li><a class="text-hover-purple" href="investment_plans.php"><i class=" site-nav--icon"></i>PLANS</a></li>
                    <li><a class="text-hover-purple" href="our_services.php"><i class=" site-nav--icon"></i> SERVICES</a></li>
                    <li><a class="text-hover-purple" href="policy.php"><i class=" site-nav--icon"></i>POLICIES</a></li>
                    <li class=" text-hover-purple"><a href="login.php"><i class=" site-nav--icon"></i>LOGIN</a></li>
                    <li class=" text-hover-purple"><a href="register.php"><i class=" site-nav--icon"></i>REGISTER</a></li>
                </ul>
            </nav>
    ...
    <div class=" text-hover-purple p-2 fixed">
    ...
    <div class="container mt-5">
        <div class="row justify-center">
            <div class="col-12-xs col-5-md">
                <h2>
                    <div class="font-xxl text-hover-purple text-purple">ABOUT ARKINVEST</div>

                </h2>
                <p class="text-gray m-3">Arkinvest is a company registered in the United Kingdom focused for over three years on specialized investments such as stock option, foreign exchange, and crypto currency exchange markets. Arkinvest is in the practice of taking advantage of a price difference between two or more markets striking a combination of matching deals that capitalize upon the imbalance, the profit being the difference between the market price.
                    Arkinvest is present when there is an opportunity to instantaneously buy low and sell high which is one of the attributes that makes Arkinvest one of the most profitable and risk-free companies around the internet. <br><br>


                    Manned by a professional team of Arkinvest seasoned professionals and experts who handle all transactions of our clients in such a way that we are assured of a maximum success rate in terms of profitizing. Our clients also have the opportunity to reinvest their profits resulting in even more aggressive growth, withdrawals being processed within a matter of hours. <br><br>


                    Our mission is to provide every person the opportunity to gain maximal profit from investing at minimal risk and by utilizing several investment pools it allows us to maintain consistent high interest rates for our clients, the insurance and flexibility in investing funds, automated and standard computed systems in both deposit and withdrawal processing. And also ultra-safe and secure transactions being the strongest advantage we have over our competitors. Arkinvest is simply home to both aspiring and expert investors.


                </p>

            </div>
            <div class="col-12-xs p-3 col-5-md">
                <img src="./public/images/ark-funds-homepage-illustration.svg" alt="">
            </div>
        </div>
    </div>
    ...
    <section id="work" class="mt-5">
        <div class="Container">
            <h2 class="mb-2">WHY <span class="text-hover-purple custom-color">ARKINVEST?</span></h2>
            <div class="row gap-2">
                <div class="col-12-xs col-6-md col-3-lg">
                    <div class="card p-0 custom-bg custom-color">
    ...
    <div class="Container">
        ...
        <h2 class="container m-3 text-hover-purple">FROM OUR CLIENTS <i></i></h2>

        <div class="col-12-xs col-6-md col-1-lg custom-color">
            ...
            <div class="form-div">
                <form action="https://formspree.io/f/mlezpnpv" method="post">
                    ...
                    <div class="d-grid gap-2 col-4 mx-auto">
                        <input id="button-reply" class="btn-info mb-2" type="submit" value="Submit"><br>
                    </div>
            </div>
            </form>
        </div>
